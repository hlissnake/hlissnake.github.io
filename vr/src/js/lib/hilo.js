 ...
 * @module hilo/util/ParticleSystem
 * @requires hilo/core/Class
 * @requires hilo/core/Hilo
 * @requires hilo/display/Bitmap
 * @requires hilo/display/Container
 * @requires hilo/display/View
 * @requires hilo/display/Drawable
 */
var ParticleSystem = (function(){
     ...
     *  }
     */
    var ParticleSystem = Class.create({
        Extends:Container,
